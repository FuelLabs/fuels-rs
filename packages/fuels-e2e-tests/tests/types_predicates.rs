...
async fn spend_predicate_coins_messages_address() -> Result<()> {
    abigen!(Predicate(
        name = "MyPredicate",
        abi = "packages/fuels-e2e-tests/tests/types/predicates/address/out/debug/address-abi.json"
    ));
...
async fn spend_predicate_coins_messages_enums() -> Result<()> {
    abigen!(Predicate(
        name = "MyPredicate",
        abi = "packages/fuels-e2e-tests/tests/types/predicates/enums/out/debug/enums-abi.json"
    ));
...
async fn spend_predicate_coins_messages_structs() -> Result<()> {
    abigen!(Predicate(
        name = "MyPredicate",
        abi = "packages/fuels-e2e-tests/tests/types/predicates/structs/out/debug/structs-abi.json"
    ));
...
async fn spend_predicate_coins_messages_tuple() -> Result<()> {
    abigen!(Predicate(
        name = "MyPredicate",
        abi = "packages/fuels-e2e-tests/tests/types/predicates/predicate_tuples/out/debug/predicate_tuples-abi.json"
    ));
...
async fn spend_predicate_coins_messages_vectors() -> Result<()> {
    abigen!(Predicate(name="MyPredicate", abi="packages/fuels-e2e-tests/tests/types/predicates/predicate_vectors/out/debug/predicate_vectors-abi.json"));
...
async fn spend_predicate_coins_messages_generics() -> Result<()> {
    abigen!(Predicate(name="MyPredicate", abi="packages/fuels-e2e-tests/tests/types/predicates/predicate_generics/out/debug/predicate_generics-abi.json"));
...
async fn spend_predicate_coins_messages_bytes() -> Result<()> {
    abigen!(Predicate(
        name = "MyPredicate",
        abi = "packages/fuels-e2e-tests/tests/types/predicates/predicate_bytes/out/debug/predicate_bytes-abi.json"
    ));
...
async fn spend_predicate_coins_messages_raw_slice() -> Result<()> {
    abigen!(Predicate(
        name = "MyPredicate",
        abi = "packages/fuels-e2e-tests/tests/types/predicates/predicate_raw_slice/out/debug/predicate_raw_slice-abi.json"
    ));
...
async fn predicate_handles_u128() -> Result<()> {
    abigen!(Predicate(
        name = "MyPredicate",
        abi = "packages/fuels-e2e-tests/tests/types/predicates/predicate_u128/out/debug/predicate_u128-abi.json"
    ));
...
async fn predicate_handles_u256() -> Result<()> {
    abigen!(Predicate(
        name = "MyPredicate",
        abi = "packages/fuels-e2e-tests/tests/types/predicates/predicate_u256/out/debug/predicate_u256-abi.json"
    ));
...
async fn predicate_handles_std_string() -> Result<()> {
    abigen!(Predicate(
        name = "MyPredicate",
        abi = "packages/fuels-e2e-tests/tests/types/predicates/predicate_std_lib_string/out/debug/predicate_std_lib_string-abi.json"
    ));
