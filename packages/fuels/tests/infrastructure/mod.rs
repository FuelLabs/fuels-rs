...
async fn test_provider_launch_and_connect() -> Result<(), Error> {
    abigen!(
        MyContract,
        "packages/fuels/tests/behaviors/contract_test/out/debug/contract_test-abi.json"
    );
    ...
    let contract_id = Contract::deploy(
        "tests/behaviors/contract_test/out/debug/contract_test.bin",
        &wallet,
...
async fn contract_deployment_respects_maturity() -> Result<(), Error> {
    abigen!(
        MyContract,
        "packages/fuels/tests/behaviors/transaction_block_height/out/debug/transaction_block_height-abi.json"
    );
    ...
    let deploy_w_maturity = |maturity| {
        ...
        Contract::deploy(
            "tests/behaviors/transaction_block_height/out/debug/transaction_block_height.bin",
            wallet,
            parameters,
            StorageConfiguration::default(),
        )
