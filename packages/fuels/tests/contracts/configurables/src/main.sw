...
abi TestContract {
    fn return_configurables() -> (bool, u8, u16, u32, u64, u256, str[4], (u8, bool), [u32; 3], StructWithGeneric<u8>, EnumWithGeneric<bool>);
}

impl TestContract for Contract {
    fn return_configurables() -> (bool, u8, u16, u32, u64, u256, str[4], (u8, bool), [u32; 3], StructWithGeneric<u8>, EnumWithGeneric<bool>) {
        (BOOL, U8, U16, U32, U64, U256, STR_4, String, TUPLE, ARRAY, STRUCT, ENUM)
    }
}
