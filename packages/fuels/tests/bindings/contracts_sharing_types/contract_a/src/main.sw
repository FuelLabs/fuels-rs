...
struct EnumSameNameButDifferentInternals {
    a: u32,
}
...
abi MyContract {
    ...
    fn used_shared_type_inside_owned_one(arg1: UniqueStructToContractA<SharedStruct2<u8>>) -> UniqueStructToContractA<SharedStruct2<u8>>;
}
...
impl MyContract for Contract {
    ...
    fn used_shared_type_inside_owned_one(
