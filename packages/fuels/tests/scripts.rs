...
// };
// use fuels::prelude::*;
// use fuels_contract::execution_script::TransactionExecution;
...
//
//     let execution_script = call_handler.get_call_execution_script().await?;
//
...
//
//     let provider = &wallet.get_provider()?;
//     let execution_script = multi_call_handler.get_call_execution_script().await?;
//     let receipts = execution_script.call(provider).await.unwrap();
...
//     .collect();
//
//     let execution_script = TransactionExecution::from_binary(
//         script_binary,
//         tx_parameters,
//         Some(script_data),
//         Some(inputs),
...
//     );
//     let provider = wallet.get_provider()?;
//     let _result = execution_script.call(provider).await;
//
...
// //     let script = ::from_binary_filepath(path_to_bin, None, None, None, None)?;
