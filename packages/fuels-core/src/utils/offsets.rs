...
pub fn base_offset_script(consensus_parameters: &ConsensusParameters) -> usize {
    consensus_parameters
        .tx_params()
        .tx_offset()
        .saturating_add(fuel_tx::Script::script_offset_static())
}
...
pub fn base_offset_create(consensus_parameters: &ConsensusParameters) -> usize {
    ...
    consensus_parameters
        .tx_params()
        .tx_offset()
        .saturating_add(fuel_tx::Create::salt_offset_static())
        .saturating_add(Bytes32::LEN)
}
...
pub fn call_script_data_offset(
    ...
    base_offset_script(consensus_parameters).saturating_add(padded_len_usize(
        calls_instructions_len.saturating_add(opcode_len),
    ))
}
...
pub fn coin_predicate_data_offset(code_len: usize) -> usize {
    InputRepr::Coin
        ...
        .saturating_add(padded_len_usize(code_len))
}
...
pub fn message_predicate_data_offset(message_data_len: usize, code_len: usize) -> usize {
    InputRepr::Message
        ...
        .saturating_add(padded_len_usize(message_data_len))
        .saturating_add(padded_len_usize(code_len))
}
