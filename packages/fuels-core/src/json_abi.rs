...
mod tests {
    ...
    use fuels_types::{errors::Error, TypeApplication};
    ...
    fn fn_selector_single_primitive() -> Result<(), Error> {
        ...
        let params = vec![p];
        let selector = build_fn_selector("my_func", &params, &types)?;
    ...
    fn fn_selector_multiple_primitives() -> Result<(), Error> {
        let p1 = TypeDeclaration {
            type_id: 0,
            type_field: "u64".into(),
            ..Default::default()
        };
        let p2 = TypeDeclaration {
            type_id: 1,
            type_field: "bool".into(),
            ..Default::default()
        };
        let types = [(0, p1.clone()), (1, p2.clone())]
            .into_iter()
            .collect::<HashMap<_, _>>();
    ...
    fn fn_selector_custom_type() -> Result<(), Error> {
        let inner_foo = TypeDeclaration {
            type_id: 0,
            type_field: "bool".into(),
            ..Default::default()
        };

        let inner_bar = TypeDeclaration {
            type_id: 1,
            type_field: "u64".into(),
            ..Default::default()
        };
        ...
        let p_enum = TypeDeclaration {
            type_id: 3,
            type_field: "enum MyEnum".into(),
            components: Some(components),
            ..Default::default()
        };
        types.insert(3, p_enum.clone());
    ...
    fn fn_selector_nested_struct() -> Result<(), Error> {
        ...
        let inner_a = TypeDeclaration {
            type_id: 1,
            type_field: "u64".into(),
            ..Default::default()
        };

        let inner_b = TypeDeclaration {
            type_id: 2,
            type_field: "u32".into(),
            ..Default::default()
        };

        let bar_components = vec![
            TypeApplication {
                name: "a".to_string(),
                type_field: 1,
                ..Default::default()
        ...
        let inner_bar = TypeDeclaration {
            ...
            components: Some(bar_components),
            ..Default::default()
        };

        let p_components = vec![
            TypeApplication {
                name: "foo".to_string(),
                type_field: 0,
                ..Default::default()
    ...
    fn fn_selector_nested_custom_types() -> Result<(), Error> {
        ...
        let mut inner_custom = TypeDeclaration {
            type_id: 3,
            type_field: "enum InnerEnum".into(),
            components: Some(custom_components),
            ..Default::default()
        };
        ...
        let p = TypeDeclaration {
            type_id: 4,
            type_field: "struct MyStruct".into(),
            components: Some(p_components.clone()),
            ..Default::default()
        };
        ...
        types.insert(inner_custom.type_id, inner_custom);
        let p = TypeDeclaration {
            type_id: 5,
            type_field: "enum MyEnum".into(),
            components: Some(p_components),
