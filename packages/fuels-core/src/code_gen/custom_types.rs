...
mod tests {
    ...
    use super::*;
    use crate::{Error, FullTypeDeclaration};
    ...
    fn test_expand_custom_enum() -> Result<(), Error> {
        ...
        .into_iter()
        .collect::<HashMap<_, _>>();
        let actual = expand_custom_enum(&FullTypeDeclaration::from_type_declaration(&p, &types))?
            .to_string();
    ...
    fn test_enum_with_no_variants_cannot_be_constructed() -> anyhow::Result<()> {
        ...
        let err = expand_custom_enum(&FullTypeDeclaration::from_type_declaration(&p, &types))
            .err()
    ...
    fn test_expand_custom_struct() -> Result<(), Error> {
        ...
        .into_iter()
        .collect::<HashMap<_, _>>();
        let actual = expand_custom_struct(&FullTypeDeclaration::from_type_declaration(&p, &types))?
            .to_string();
        let expected = TokenStream::from_str(
            r#"
    ...
    fn test_struct_with_no_fields_cannot_be_constructed() -> anyhow::Result<()> {
        ...
        let err = expand_custom_struct(&FullTypeDeclaration::from_type_declaration(&p, &types))
            .err()
    ...
    "#;
        ...
        let actual = expand_custom_struct(&FullTypeDeclaration::from_type_declaration(s1, &types))?
            .to_string();
        ...
        let actual = expand_custom_struct(&FullTypeDeclaration::from_type_declaration(s2, &types))?
            .to_string();
