...
mod tests {
    ...
    fn test_expand_custom_enum() -> Result<(), Error> {
        ...
        .into_iter()
        .collect::<HashMap<_, _>>();
        let actual = expand_custom_enum(&p.to_full_declaration(&types))?.to_string();
    ...
    fn test_enum_with_no_variants_cannot_be_constructed() -> anyhow::Result<()> {
        ...
        let err = expand_custom_enum(&p.to_full_declaration(&types))
            .err()
    ...
    fn test_expand_custom_struct() -> Result<(), Error> {
        ...
        .into_iter()
        .collect::<HashMap<_, _>>();
        let actual = expand_custom_struct(&p.to_full_declaration(&types))?.to_string();
        let expected = TokenStream::from_str(
            r#"
    ...
    fn test_struct_with_no_fields_cannot_be_constructed() -> anyhow::Result<()> {
        ...
        let err = expand_custom_struct(&p.to_full_declaration(&types))
            .err()
    ...
    "#;
        ...
        let actual = expand_custom_struct(&s1.to_full_declaration(&types))?.to_string();
        ...
        let actual = expand_custom_struct(&s2.to_full_declaration(&types))?.to_string();
