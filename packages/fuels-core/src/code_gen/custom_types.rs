...
mod tests {
    ...
    fn test_expand_custom_enum() -> Result<(), Error> {
        ...
        .collect::<HashMap<_, _>>();
        let actual =
            expand_custom_enum(&FullTypeDeclaration::from_counterpart(&p, &types))?.to_string();
    ...
    fn test_expand_custom_struct() -> Result<(), Error> {
        ...
        .collect::<HashMap<_, _>>();
        let actual =
            expand_custom_struct(&FullTypeDeclaration::from_counterpart(&p, &types))?.to_string();
        let expected = TokenStream::from_str(
            r#"
    ...
    "#;
        ...
        let actual =
            expand_custom_struct(&FullTypeDeclaration::from_counterpart(s1, &types))?.to_string();
        ...
        let actual =
            expand_custom_struct(&FullTypeDeclaration::from_counterpart(s2, &types))?.to_string();
