...
impl Abigen {
    ...
    pub fn new<S: AsRef<str>>(contract_name: &str, abi_source: S) -> Result<Self, Error> {
        ...
        // Return error if the function name is empty and
...
mod tests {
    ...
    #[test]
    fn error_on_empty_function_name() {
        let contract = r#"
        [
            {
                "type":"contract",
        ...
        if let Some(result_error) = Abigen::new("test", contract).err() {
            assert_eq!(
    ...
    #[test]
    fn error_on_empty_argument_names() {
        let contract = r#"
        [
            {
                "type":"contract",
        ...
        if let Some(result_error) = Abigen::new("test", contract).unwrap().generate().err() {
            assert_eq!(
                result_error.to_string(),
