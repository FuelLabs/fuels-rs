        ...
        let (includes, code) = if self.no_std {
            (
                quote! {
                    ...
                    use fuels_core::{EnumSelector, EnumVariants, InvalidOutputType, Parameterize, ParamType, Tokenizable, Token};
                },
                quote! {},
            )
        } else {
            (
                quote! {
                    ...
                    use fuels::core::{EnumSelector, EnumVariants, InvalidOutputType, Parameterize, ParamType, Tokenizable, Token};
                    use std::str::FromStr;
                },
                quote! {
                    pub struct #name {
