use crate::{
    ...
    call_utils::{find_contract_not_in_inputs, is_missing_output_variables},
    contract::{SetableContract, DEFAULT_TX_DEP_ESTIMATION_ATTEMPTS},
    execution_script::ExecutableFuelCall,
    logs::{decode_revert_error, LogDecoder},
};
use fuel_gql_client::fuel_tx::{Output, Receipt};
use fuel_tx::{Address, AssetId};

use crate::call_utils::get_decoded_output;
use fuels_core::{
