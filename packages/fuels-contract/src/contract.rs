use crate::{
    contract_calls::{ContractCall, ContractCallHandler},
    logs::LogDecoder,
};
use fuel_gql_client::fuel_tx::{Contract as FuelContract, Output, StorageSlot, Transaction};
use fuel_tx::{Checkable, Create, Salt};
use fuels_core::{
