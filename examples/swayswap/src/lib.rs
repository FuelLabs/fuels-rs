...
mod tests {
    ...
    async fn swayswap_test() {
        ...
        /////////////////////////////
        abigen!(TestSwayswap, "../../packages/fuels-abigen-macro/tests/test_projects/swayswap/swayswap_contract/out/debug/swayswap_contract-abi.json");

        let swayswap_salt = Salt::from([0u8; 32]);
        let swayswap_compiled = Contract::load_sway_contract(
            "tests/test_projects/swayswap/swayswap_contract/out/debug/swayswap_contract.bin",
            swayswap_salt,
        )
        .unwrap();
        ...
        let contract_id = ContractId::from_str(&NATIVE_ASSET_ID.to_string()).unwrap();
        swayswap_instance
            .withdraw(11, contract_id)
        ...
        //////////////////////////
        abigen!(TestToken, "packages/fuels-abigen-macro/tests/test_projects/swayswap/token_contract/out/debug/token_contract-abi.json");
        let token_salt = Salt::from([0u8; 32]);
        let token_compiled = Contract::load_sway_contract(
            "tests/test_projects/swayswap/token_contract/out/debug/token_contract.bin",
            token_salt,
        )
        .unwrap();
        ...
        let result = token_instance
            .get_balance(token_contract_id, token_contract_id)
            .call()
            .await
            .unwrap();
        ...
        token_instance
            .transfer_coins_to_output(50, token_contract_id, wallet.address())
            .append_variable_outputs(1)
            .call()
            .await
            .unwrap();
        ...
        token_instance
            .transfer_coins_to_output(100, token_contract_id, wallet.address())
            .append_variable_outputs(1)
            .call()
            .await
            .unwrap();
