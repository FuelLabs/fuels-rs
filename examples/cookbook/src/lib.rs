...
mod tests {
    ...
    async fn liquidity() -> Result<(), Error> {
        ...
        abigen!(
            MyContract,
            "packages/fuels/tests/examples/liquidity_pool/out/debug/liquidity_pool-abi.json"
        );
        ...
        let contract_id = Contract::deploy(
            "../../packages/fuels/tests/examples/liquidity_pool/out/debug/liquidity_pool.bin",
            wallet,
