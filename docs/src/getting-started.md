...
Another way to experience the SDK is to look at the source code. The `packages/fuels-e2e-tests/tests/` folder is full of integration tests that go through almost all aspects of the SDK.
