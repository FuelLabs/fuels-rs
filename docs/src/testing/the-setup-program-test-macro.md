...
```rust,ignore
{{#include ../../../packages/fuels-e2e-tests/tests/contracts.rs:contract_setup_macro_multi}}
```
...
```rust,ignore
{{#include ../../../packages/fuels-e2e-tests/tests/contracts.rs:contract_setup_macro_manual_wallet}}
```
