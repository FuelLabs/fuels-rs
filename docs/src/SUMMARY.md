...
- [Managing wallets](./new_wallets/index.md)
  - [Using private keys](./new_wallets/private_key_signer.md)
    - [Keystore](./new_wallets/keystore.md)
  - [Using AWS KMS](./new_wallets/aws_kms.md)
  - [Using a fake signer (impersonating)](./new_wallets/fake_signer.md)
  - [Querying](./new_wallets/checking-balances-and-coins.md)
  - [Testing](./new_wallets/test-wallets.md)
  - [Locking](./new_wallets/access.md)
  - [Signing](./new_wallets/signing.md)
