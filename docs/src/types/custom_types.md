...
```rust,ignore
{{#include ../../../packages/fuels/tests/contract_types.rs:struct_generation}}
```
...
```rust,ignore
{{#include ../../../packages/fuels/tests/contract_types.rs:manual_decode}}
```
...
```rust,ignore
{{#include ../../../packages/fuels/tests/contract_types.rs:generic}}
```
