...
pub fn expand_internal_struct(prop: &Property) -> Result<TokenStream, Error> {
        ...
        match param_type {
            ...
            ParamType::Struct(_params) => {
                let struct_name = ident(
                    &extract_custom_type_name_from_abi_property(component, "struct")?
                        .to_class_case(),
                );
    ...
    let name = ident(&extract_custom_type_name_from_abi_property(prop, "struct")?.to_class_case());
...
pub fn extract_custom_type_name_from_abi_property(
    ...
    if declared_type != String::from(expected) {
...
mod tests {
    ...
    fn test_extract_custom_type_name_from_abi_property_bad_data() {
        ...
        let result = extract_custom_type_name_from_abi_property(&p, "");
    ...
    fn test_extract_struct_name_from_abi_property_wrong_type() {
        ...
        let result = extract_custom_type_name_from_abi_property(&p, "struct");
        ...
        let result = extract_custom_type_name_from_abi_property(&p, "enum");
        assert!(matches!(result, Err(Error::InvalidType(_))));
    }
